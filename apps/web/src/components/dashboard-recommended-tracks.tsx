...
export function DashboardRecommendedTracks({
  tracks,
}: {
  ...
  }, [updateScrollState, tracks.length]);
    ...
    <div className="dashboard-carousel">
      <div className="dashboard-carousel-viewport">
        <button
          ...
          aria-label="Previous problem tracks"
        ...
        <div
          ...
          role="region"
          aria-label="Recommended problem tracks"
        >
          {tracks.map((t) => (
            <div key={t.slug} className="dashboard-carousel-item">
              <ProblemTrackCard track={t} compact variant="dashboard" />
            </div>
          ))}
        </div>
        ...
        <button
          ...
          aria-label="Next problem tracks"
